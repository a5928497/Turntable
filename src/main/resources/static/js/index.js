$(function () {
    ...
    // css("width",body_width*btn_width_rate).css("height",body_height*btn_height_rate)
    // $submitBTN.offset({top:body_height*btn_top_rate,left:body_height*btn_left_rate});
})